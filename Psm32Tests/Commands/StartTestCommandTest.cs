...
public class StartTestCommandTest
{
    ...
    public StartTestCommandTest()
    {
        ...
        _mockMessageSender.Setup(x => x.ChannelSetRamp(It.IsAny<int>(), It.IsAny<char?>(), It.IsAny<int>(), It.IsAny<int>()))
            .Verifiable();
        _mockMessageSender.Setup(
            x => x.ChannelSetPulse(It.IsAny<int>(), It.IsAny<char?>(), 
            It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>()))
            .Verifiable();
        _mockMessageSender.Setup(x => x.ChannelGoRun(It.IsAny<int>(), It.IsAny<char?>()))
            .Verifiable();  
    ...
    public async void Execute_OneAvailableMuscle()
    {
        ...
        var startTestCommand = new StartTestCommand(vm, _deviceStoreFixture.DeviceStore, _mockMessageSender.Object);


        startTestCommand.Execute(null);

        _mockMessageSender.Verify(m => m.ChannelSetRamp(It.IsAny<int>(), It.IsAny<char?>(), It.IsAny<int>(), It.IsAny<int>()), Times.Never);
        _mockMessageSender.Verify(m => m.ChannelSetPulse(It.IsAny<int>(), It.IsAny<char?>(),
            It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>()), Times.Once);
        _mockMessageSender.Verify(m => m.ChannelGoRun(It.IsAny<int>(), It.IsAny<char?>()), Times.Once);
    }

    [Fact]
    public async void Execute_TwoMusclesWithRampUp()
    {
        var units = new List<QSUnit>()
        {
            new(1),
        ...
        _mockMessageSender.Verify(m => m.ChannelSetRamp(It.IsAny<int>(), It.IsAny<char?>(), It.IsAny<int>(), It.IsAny<int>()), Times.Exactly(2));
        _mockMessageSender.Verify(m => m.ChannelSetPulse(It.IsAny<int>(), It.IsAny<char?>(),
            It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>()), Times.Exactly(2));
        _mockMessageSender.Verify(m => m.ChannelGoRun(It.IsAny<int>(), It.IsAny<char?>()), Times.Exactly(2));
    }

    [Fact]
    public async void Execute_NoAvailableMusles()
    {
        var units = new List<QSUnit>()
        {
            new(1),
        ...
        _mockMessageSender.Verify(m => m.ChannelSetRamp(It.IsAny<int>(), It.IsAny<char?>(), It.IsAny<int>(), It.IsAny<int>()), Times.Never);
        _mockMessageSender.Verify(m => m.ChannelSetPulse(It.IsAny<int>(), It.IsAny<char?>(),
            It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>()), Times.Never);
        _mockMessageSender.Verify(m => m.ChannelGoRun(It.IsAny<int>(), It.IsAny<char?>()), Times.Never);
    }
    ...
    public async void Execute_NoAvailableUnit()
    {
        ...
        var stopTestCommand = new StartTestCommand(vm, _deviceStoreFixture.DeviceStore, _mockMessageSender.Object);
