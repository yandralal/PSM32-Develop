...
public class PauseTestCommandTest
{
    ...
    public async void Execute_OneAvailableMuscle()
    {
        ...
        var stopTestCommand = new PauseTestCommand(vm, _deviceStoreFixture.DeviceStore, _mockMessageSender.Object);
